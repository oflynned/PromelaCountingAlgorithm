...
{	Trans *T;
	...
	trans[1][1]	= settr(8,0,2,11,11,"qruns = 1", 1, 2, 0);
	trans[1][2]	= settr(9,0,3,12,12,"t = 0", 1, 2, 0);
	trans[1][3]	= settr(10,0,4,13,0,"(((pruns==0)||(t==1)))", 1, 2, 0);
	trans[1][4]	= settr(11,0,5,14,14,"n = (n+1)", 1, 2, 0);
	trans[1][5]	= settr(12,0,6,15,0,"printf('count via pid %d at qcount %d/10: %d\\n',_pid,qcount,n)", 1, 2, 0);
	trans[1][6]	= settr(13,0,7,16,16,"qcount = (qcount+1)", 1, 2, 0);
	trans[1][7]	= settr(14,0,8,17,17,"qruns = 0", 1, 2, 0);
	trans[1][8]	= settr(15,0,0,18,18,"-end-", 0, 3500, 0);

	/* proctype 0: PCount */

	trans[0] = (Trans **) emalloc(9*sizeof(Trans *));

	trans[0][1]	= settr(0,0,2,19,19,"pruns = 1", 1, 2, 0);
	trans[0][2]	= settr(1,0,3,20,20,"t = 1", 1, 2, 0);
	trans[0][3]	= settr(2,0,4,21,0,"(((qruns==0)||(t==0)))", 1, 2, 0);
	trans[0][4]	= settr(3,0,5,22,22,"n = (n+1)", 1, 2, 0);
	trans[0][5]	= settr(4,0,6,23,0,"printf('count via pid %d at pcount %d/10: %d\\n',_pid,pcount,n)", 1, 2, 0);
	trans[0][6]	= settr(5,0,7,24,24,"pcount = (pcount+1)", 1, 2, 0);
	trans[0][7]	= settr(6,0,8,25,25,"pruns = 0", 1, 2, 0);
	trans[0][8]	= settr(7,0,0,26,26,"-end-", 0, 3500, 0);
	/* np_ demon: */
